...
class popupWindow(object):
    ...
    def cleanup(self):
        ...
        access = '4eb62d814867846a8d0f1c994e17aa680d1c2c0abe8445bb3a85c0f3be339686a5142378c0f02fab58164831a3a7d1e25d67647ef4b4aee41b861c2ec16115bc'
        data = self.value
        data = data.encode()
        wp = whirlpool.new(data)
        hashed_string = wp.hexdigest()
        if hashed_string == access:
            self.loop = True
            self.top.destroy()
            window.deiconify()
        else:
...
name_label = Label(window, text='Place: ', font=('Courier', 14))
...
name_label2 = Label(window, text='Place: ', font=('Courier', 14))
